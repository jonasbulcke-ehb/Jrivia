...
class IntentExtraNames {
    companion object {
        ...
        const val DAILY_QUEST = "be.gdt.jrivia.util.IntentExtraNames.DAILY_QUEST"
        const val DAILY_QUEST_INDEX = "be.gdt.jrivia.util.IntentExtraNames.DAILY_QUEST_INDEX"
    }
}